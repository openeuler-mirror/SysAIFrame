...
Desc: Translates from Chat Completion API to DeepSeek's API
      Based on litellm.llms.deepseek.chat.transformation with stub modifications
Date: 2025-11-17
Author: Liu Mingran
"""
...
class DeepSeekChatConfig(OpenAIGPTConfig):
    ...
    def transform_request(
        ...
        multi-turn thinking-mode conversations.
